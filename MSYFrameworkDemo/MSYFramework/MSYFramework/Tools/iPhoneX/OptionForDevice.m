...
@implementation OptionForDevice
...
+(NSString *)getDeviceName{
    ...
    if ([deviceString isEqualToString:@"iPhone5,3"])    return @"iphone5";
    if ([deviceString isEqualToString:@"iPhone5,4"])    return @"iphone5";
    if ([deviceString isEqualToString:@"iPhone6,1"])    return @"iphone5";
    if ([deviceString isEqualToString:@"iPhone6,2"])    return @"iphone5";
